...
export default function ClientComponent({ status, access_token, refresh_token }) {
    useEffect(() => {
        (async () => {
    ...
    return (
        <div>
            <div className="fixed inset-0 z-50 bg-white flex items-center justify-center flex-col">
                <Image
                    width={300}
                    height={300}
                    alt="Logo"
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <span className="text-[14px] text-slate-400 font-semibold">Signing in...</span>
                </div>
            </div>
        </div>
    )
